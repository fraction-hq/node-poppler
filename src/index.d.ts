export class Poppler {
     ...
     */
    pdfAttach(file: string, fileToAttach: string, outputFile: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfDetach(file: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfFonts(file: Buffer | string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfImages(file: Buffer | string, outputPrefix?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfInfo(file: Buffer | string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfSeparate(file: string, outputPattern: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToCairo(file: Buffer | string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToHtml(file: Buffer | string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToPpm(file: Buffer | string, outputPath: string, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToPs(file: Buffer | string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfToText(file: Buffer | string, outputFile?: string | undefined, options?: object | undefined): Promise<string | Error>;
    /**
     * @author Frazer Smith
     ...
     * @returns {Promise<string|Error>} Promise of stdout string on resolve, or Error object on rejection.
     */
    pdfUnite(files: any[], outputFile: string, options?: object | undefined): Promise<string | Error>;
}
